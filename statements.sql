...
UPDATE usuarios SET id_rol = 1 WHERE nombre IN ('Juan', 'Pedro', 'Miguel', 'Carmen', 'Isabel');
UPDATE usuarios SET id_rol = 2 WHERE nombre IN ('Maria', 'Laura', 'Sofia', 'Raquel', 'Paula');
UPDATE usuarios SET id_rol = 3 WHERE nombre IN ('Carlos', 'Luis', 'Alejandro', 'Hector', 'Alberto');
UPDATE usuarios SET id_rol = 4 WHERE nombre IN ('Ana', 'Javier', 'Daniel', 'Adrian', 'Elena');
...
UPDATE usuarios SET id_categoria = 6 WHERE id_usuario IN (10, 13);
UPDATE usuarios SET id_categoria = 7 WHERE id_usuario IN (12, 14);
UPDATE usuarios SET id_categoria = 8 WHERE id_usuario IN (15, 17);
